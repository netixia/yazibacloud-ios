...
//URLs Setting
#define k_help_url @"http://www.yaziba.net/mobile/help"
#define k_recomended_url @"http://www.yaziba.net/mobile/recommend"
#define k_send_feedback @"http://www.yaziba.net/mobile/feedback"
...
#define k_default_url_server @"https://cloud.yaziba.net/yazibacloud/"
...
//Mail feedback
#define k_mail_feedback @"mobileapps@netixia.fr"
...
#define k_twitter_user @"@yazibanet"
...
#define k_url_link_on_login @"http://www.yaziba.net/mobile/new"

//User-Agent
#define k_user_agent @"Mozilla/5.0 (iOS) YaZibaCloud-iOS/"
